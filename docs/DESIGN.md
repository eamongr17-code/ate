...
4. **Receipts are what Ate prints** (white paper, mono type, dashed rules, dot leaders, torn bottom
   ...
   **Torn edges only on dish entry slips** (the statement slip on You/Profile is whole, 16 all round).
...
| slip (list card) | `#FFFFFF`, ink text | `#231B24`, `#F4EFE9` text; chip/field `#342A3A`, hairline white @ 12%, rules white @ 22% |
